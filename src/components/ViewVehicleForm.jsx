      ...
      <div className="view-form-container mt-4">
        <form className="contact-view-form pt-4">
          ...
          <div className="row mb-3 name-surname">
            <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
              <div className="form-group">
                <label className="view-form-label" htmlFor="firstName">
                  Your Name
                </label>
                <input
                  type="text"
            ...
            <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
              <div className="form-group">
                <label htmlFor="lastName" className="view-form-label">
                  Your Surname
                </label>
                <input
                  type="text"
          ...
          <div className="form-group col-12 mb-3">
            <label htmlFor="cellNumber" className="view-form-label">
              Your Cell Number
            </label>
            <input
              type="number"
          ...
          <div className="form-group col-12 mb-3">
            <label htmlFor="emailAddress" className="view-form-label">
              Your Email Address
            </label>
            <input
              type="email"
          ...
          <div className="form-group w-100 mt-5">
            <button
              type="button mt-2 send-message-button"
