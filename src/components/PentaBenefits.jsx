  ...
  return (
    <>
      <div className="container-approved">
        ...
        <div className="row approved-row">
          ...
          <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 ps-xxl-0 ps-xl-0 ps-lg-3 ps-md-3 ps-3 approved-text">
            <p className="mb-0 fs-7 approved-paragraph">
              ...
              uncertainties. But what if you could experience the peace of mind
              of a new car purchase with the value of pre-owned? That's the
              promise of Penta Now Approved.
            </p>
            <p className="mb-0 fs-7 approved-paragraph">
        ...
        <p className="paragraph-end">Drive away with confidence. Choose Penta Now Approved Today!</p>
      </div>
    </>
  );
};
