        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-7 mb-4 mb-md-0">
              <h2 className="mb-0 text-white">Want to sell your car?</h2>
              <p className="mb-0 opa-7">
                Book A Free Vehicle Evaluation Today With PentaNow & Get An
                Offer In 1 Hour After Vehicle Assessment – We Will Come To You
